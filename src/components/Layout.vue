<template>
  <div>
    ...
    <my-dialog :isShow='isShowLog' @close="close('isShowLog')">
     <log-form></log-form>
    </my-dialog>
     <my-dialog :isShow='isShowReg' @close="close('isShowReg')">
     <reg-form></reg-form>
    </my-dialog>
     <my-dialog :isShow='isShowAbout' @close="close('isShowAbout')">
